...
describe("runBriefingWorkflow", () => {
    ...
    it("returns approved state from workflow", async () => {
        ...
        const result = await runBriefingWorkflow(mockFactBundle, "upload-123", "2026-04", mockEnv);
    ...
    it("handles timeout gracefully", async () => {
        vi.mocked(graphModule.executeGraph).mockRejectedValueOnce(new Error("Operation timeout after 300000ms"));
        const result = await runBriefingWorkflow(mockFactBundle, "upload-123", "2026-04", mockEnv);
